    ...
    >
      <div className="animate-float">
        ...
        <h1 className="text-6xl font-black text-slate-800 mt-4 leading-tight">
          {GAME_DATA.hero.title}
          <span className="block text-3xl text-indigo-600 font-medium mt-2">{GAME_DATA.hero.subtitle}</span>
        </h1>
        <p className="text-slate-600 mt-4 text-lg max-w-lg">{GAME_DATA.hero.description}</p>
      ...
      <div className="flex gap-6 mt-12">
        {GAME_DATA.hero.stats.map((stat, idx) => (
