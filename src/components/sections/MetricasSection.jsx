      ...
      <div className="flex gap-12 items-center">
        <div className="w-[400px]">
          ...
          <div className="grid grid-cols-2 gap-4">
            {RETROSPECTIVA_GAMIFICADA_DESKTOP_DATA.metricas.quality.map((q, i) => (
        ...
        <div className="flex gap-4">
          <div className="bg-white p-6 rounded-2xl shadow-xl border-t-8 border-indigo-500 w-56">
            ...
            <div className="text-4xl font-black text-indigo-600">{RETROSPECTIVA_GAMIFICADA_DESKTOP_DATA.metricas.leadTime.value}</div>
            <div className="text-xs text-slate-500 mt-2 bg-slate-50 px-2 py-1 inline-block rounded">P85: {RETROSPECTIVA_GAMIFICADA_DESKTOP_DATA.metricas.leadTimeP85}d</div>
          </div>
          <div className="bg-white p-6 rounded-2xl shadow-xl border-t-8 border-emerald-500 w-56">
            ...
            <div className="text-4xl font-black text-emerald-600">{RETROSPECTIVA_GAMIFICADA_DESKTOP_DATA.metricas.cycleTime.value}</div>
            <div className="text-xs text-slate-500 mt-2 bg-slate-50 px-2 py-1 inline-block rounded">P85: {RETROSPECTIVA_GAMIFICADA_DESKTOP_DATA.metricas.cycleTimeP85}d</div>
          </div>
        </div>
      </div>
    </div>
